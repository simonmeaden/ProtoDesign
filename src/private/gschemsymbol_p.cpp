...
GSchemSymbolPrivate::GSchemSymbolPrivate(GSchemSymbol *q) :
    q_ptr(q),
    bCompoundComponent(false) {

}

GSchemSymbolPrivate::~GSchemSymbolPrivate() {}

bool GSchemSymbolPrivate::read(QString filename) {
...
void GSchemSymbolPrivate::addShape(Shape *shape) {
    mShapes.append(shape);
}


void GSchemSymbolPrivate::removeShape(Shape *shape) {
    mShapes.removeOne(shape);
}


Pin* GSchemSymbolPrivate::parsePin(QStringList parts) {
    int x1, y1, x2, y2;
...
Path* GSchemSymbolPrivate::parsePath(QStringList parts, QTextStream *is) {
...
Component* GSchemSymbolPrivate::parseComponent(QStringList parts) {
...
Rectangle* GSchemSymbolPrivate::parseBox(QStringList parts) {
...
Net* GSchemSymbolPrivate::parseNet(QStringList parts) {
...
Bus* GSchemSymbolPrivate::parseBus(QStringList parts) {
...
Picture* GSchemSymbolPrivate::parsePicture(QStringList parts, QTextStream *is) {
...
Circle* GSchemSymbolPrivate::parseCircle(QStringList parts) {
...
Arc* GSchemSymbolPrivate::parseArc(QStringList parts) {
...
Text* GSchemSymbolPrivate::parseText(QStringList parts, QTextStream *is) {
...
Line* GSchemSymbolPrivate::parseLine(QStringList parts) {
...
Qt::PenCapStyle GSchemSymbolPrivate::toCapStyle(int style) {
...
QPair<Qt::PenStyle, QVector<qreal> >  GSchemSymbolPrivate::toPenStyle(int style, int length, int gap) {
